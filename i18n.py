...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "Multi-arch (--multi-arch all)": "多架构 (--multi-arch all)",
        "Push the full manifest list (amd64 / arm64 / armv7, etc). Recommended when pushing multi-arch images like nginx from an ARM Mac.": "推送整张 manifest list（amd64 / arm64 / armv7 等）。在 Mac ARM 上推 nginx 等多架构镜像时建议勾选。",
        "Retry times (--retry-times)": "重试次数 (--retry-times)",
        "How many times skopeo retries on transient errors (network blip, registry 5xx, etc). 0 disables retries; max 10. Default 3 matches skopeo's own default.": "skopeo 在网络抖动、registry 5xx 等瞬时错误时的重试次数。0 表示不重试；最大 10。默认 3 与 skopeo 自身默认值一致。",
        "0 = no retries; max 10. Default 3 matches skopeo's own default.": "0 = 不重试；最大 10。默认 3 与 skopeo 自身默认值一致。",
        "Start Copy": "开始拷贝",
        "Recent tasks": "最近任务",
        "Status": "状态",
